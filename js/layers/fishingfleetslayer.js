...
const layer = createRegionLayer({
  ...
  dataUrl: 'data/fishing_fleets.json',
  idPrefix: 'ffleet',
...
registerLayerLoader('fishingfleets', { load: layer.load, flyTo: layer.FLY_TO, reset: layer.reset, dataUrl: 'data/fishing_fleets.json' });
