...
const layer = createDataLayer({
  ...
  categories: {
    ...
    aviation:  { icon: 'webcam', color: '#00ccff', label: 'AVIATION CAM',  displayDist: 8_000_000, labelDist: 2_000_000 },
    maritime:  { icon: 'webcam', color: '#ff8844', label: 'MARITIME CAM',  displayDist: 8_000_000, labelDist: 2_000_000 },
    rail:      { icon: 'webcam', color: '#ff6688', label: 'RAIL CAM',      displayDist: 8_000_000, labelDist: 2_000_000 },
