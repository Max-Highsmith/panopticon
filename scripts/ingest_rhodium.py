#!/usr/bin/env python3
"""
Ingest rhodium production sites into Panopticon format.
...
Primary sources:
  ...
  - Company annual reports and filings:
    ...
    * Royal Bafokeng Platinum (JSE: RBP) — Annual Report 2023
...
OUTPUT_FILE = OUTPUT_DIR / "rhodium.json"

SOURCE_METADATA = {
    "description": "Major global rhodium production sites",
    "origin": (
        ...
        "Northam Platinum, Royal Bafokeng Platinum annual reports and "
        "JSE filings; Norilsk Nickel MCX filings; Vale annual reports"
    ),
    "retrieved": "2026-03-09",
    "license": "USGS: public domain; company data: fair use summary",
    "notes": (
        "Rhodium is a PGM byproduct with ~25 tonnes/year global production. "
        "South Africa accounts for 80%+ of world supply. No primary rhodium "
        "mines exist — all production is a byproduct of platinum and palladium "
        "mining. Sites listed are PGM operations that produce rhodium as a "
        "significant byproduct. Rhodium is critical for automotive catalytic "
        "converters (>80% of demand). Russia (Norilsk) is the second largest "
        "source. Coordinates from USGS MRDS, company filings, and satellite "
        "verification."
    ),
}

# --- Site Data ---------------------------------------------------------------
# Each entry represents a major PGM operation that produces rhodium as a byproduct.
...
def main():
    ...
    print(f"[ingest_rhodium] Wrote {len(sites)} rhodium sites to {OUTPUT_FILE}")
