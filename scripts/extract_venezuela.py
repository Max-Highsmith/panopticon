#!/usr/bin/env python3
"""Extract aircraft traces for Venezuela region.
...
Used archive: v2026.02.28-planes-readsb-prod-0.tar (date in script uses Jan 03 window)
"""
import gzip
import json
import os
...
MIL_HEX_RANGES = [
    ...
    (0xE40000, 0xE40FFF, "Venezuela"),
    (0x890000, 0x890FFF, "Colombia"),
    (0x8A0000, 0x8A0FFF, "Cuba"),
    (0x0B0000, 0x0B0FFF, "Brazil"),
